...
L'unica release (v2.1.270, 12 set) contiene solo un fix di regressione (comandi git read-only in Bash che richiedevano permesso senza motivo dopo sessioni lunghe), sotto la soglia editoriale. L'annuncio sui limiti settimanali (+25% permanente dal 14 set) era gia' stato coperto nell'aggiornamento del 12 settembre. Nessun annuncio Anthropic blog dedicato su Claude Code nelle ultime 24 ore.
