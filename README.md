...
L'unica release (v2.1.270, 12 set) e' un singolo fix di regressione su Bash/git read-only, sotto la soglia editoriale. Digest ufficiale settimanale ancora fermo alla Week 34 (17-21 ago); nessun annuncio Anthropic blog dedicato su Claude Code ne' post team con nuova feature/comando/tool nelle ultime 24 ore.
