...
> Nessuna novita' significativa nelle ultime 24 ore. Le release intermedie (v2.1.235-238, 18-20 ago) contengono solo fix e feature minori (setting `spellcheck`, env var `ANTHROPIC_DEFAULT_MODEL`, output style "Concise", `keybindingFlavor` in stile readline), sotto la soglia editoriale — dettaglio in [docs/19-changelog.md](./docs/19-changelog.md).
