...
> Ultimo aggiornamento: **13 settembre 2026, 07:00 CEST**.
...
## What's new today (2026-09-13)

> _Aggiornamento automatico dalle 07:00 Europe/Rome. Vedi [archive](./docs/whats-new-archive.md) per i giorni precedenti._

- **CLI v2.1.270** (12 set): fix di regressione — i comandi Bash git read-only (es. `git status`, `git log`) smettevano di essere auto-approvati e chiedevano permesso dopo che una sessione girava da un po', bug introdotto in v2.1.269. Fonte: [GitHub Releases v2.1.270](https://github.com/anthropics/claude-code/releases/tag/v2.1.270). Doc: [docs/04-modalita-permessi.md](./docs/04-modalita-permessi.md), [docs/19-changelog.md](./docs/19-changelog.md).

Nessun altro annuncio Anthropic blog o post team dedicato a Claude Code nelle ultime 24 ore (nessun risultato su @bcherny, @_catwu, @noahzweben, @trq212, @claudeai, @ClaudeDevs, @alistaiir, @ClaudeCodeLog datato 12-13 set). Digest ufficiale settimanale ancora fermo alla Week 34 (17-21 ago).
