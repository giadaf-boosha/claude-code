...
> Ultimo aggiornamento: **6 luglio 2026, 07:00 CEST**.
...
## What's new today (2026-07-10)

> _Aggiornamento automatico dalle 07:00 Europe/Rome. Vedi [archive](./docs/whats-new-archive.md) per i giorni precedenti._

- **v2.1.206** (9 lug): `/cd` suggerisce ora percorsi directory (come `/add-dir`); nuovo check `/doctor` propone di sfoltire i `CLAUDE.md` versionati; `/commit-push-pr` auto-approva il push sul remote configurato (`remote.pushDefault` o l'unico remote presente); i background agent si auto-aggiornano subito dopo un update CLI. Fonte: [GitHub Releases v2.1.206](https://github.com/anthropics/claude-code/releases/tag/v2.1.206). Doc: [docs/03-slash-commands.md](./docs/03-slash-commands.md), [docs/06-claude-md-memory.md](./docs/06-claude-md-memory.md), [docs/08-subagents.md](./docs/08-subagents.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **`/code-review` piu' accurato** (v2.1.206, 9 lug): migliora la qualita' dei finding su claude-opus-4-8 a tutti gli effort level; fix a prezzi errati nel picker `/model`, `request_timeout_ms` per-server MCP ignorato e OAuth MCP re-auth loop dopo refresh fallito. Fonte: [GitHub Releases v2.1.206](https://github.com/anthropics/claude-code/releases/tag/v2.1.206). Doc: [docs/03-slash-commands.md](./docs/03-slash-commands.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **Auto mode hardening** (v2.1.205, 8 lug): blocca il tampering dei file di transcript di sessione e chiede conferma prima di un `rm -rf` su una variabile non risolvibile dal contesto; le notifiche dei background task dichiarano ora esplicitamente "nessun input umano ricevuto", per prevenire l'esecuzione di approvazioni fabbricate nel transcript. Fonte: [GitHub Releases v2.1.205](https://github.com/anthropics/claude-code/releases/tag/v2.1.205). Doc: [docs/04-modalita-permessi.md](./docs/04-modalita-permessi.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **`/doctor` diventa full setup checkup** (v2.1.205, 8 lug): diagnostica e fix automatici, alias `/checkup`; l'auto-update del binario ora streamma su disco invece di bufferizzare in memoria (-~400MB di picco memoria updater). Fonte: [GitHub Releases v2.1.205](https://github.com/anthropics/claude-code/releases/tag/v2.1.205). Doc: [docs/03-slash-commands.md](./docs/03-slash-commands.md), [docs/02-cli-installazione.md](./docs/02-cli-installazione.md), [docs/19-changelog.md](./docs/19-changelog.md).
