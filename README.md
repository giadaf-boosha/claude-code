...
L'unica release nel periodo (v2.1.263, 6 set: solo bug fix e miglioramenti di affidabilita') resta sotto la soglia editoriale. Nessun annuncio Anthropic blog dedicato su Claude Code nelle ultime 24 ore.
