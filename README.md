...
> Ultimo aggiornamento: **3 settembre 2026, 07:00 CEST**.
> Versione CLI di riferimento: **v2.1.259** · Modello default **Sonnet 5** · Premium **Fable 5.1 / Opus 5** (Max plan; Opus 4.8 rimane disponibile via `/model`).
...
## What's new today (2026-09-03)

> _Aggiornamento automatico dalle 07:00 Europe/Rome. Vedi [archive](./docs/whats-new-archive.md) per i giorni precedenti._

- **v2.1.259 introduce `managedMcpServers`** (2 set): setting gestito che permette alle organizzazioni di distribuire server MCP HTTP/SSE a tutti gli utenti, con `toolPolicy` per bloccare l'approvazione per-tool a livello di policy. Fonte: [GitHub Releases v2.1.259](https://github.com/anthropics/claude-code/releases/tag/v2.1.259). Doc: [docs/10-mcp.md § 10.4](./docs/10-mcp.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **v2.1.259 aggiunge `--permission-prompts none`** (2 set): per host headless nega automaticamente ogni azione che richiederebbe un prompt, lasciando comunque attiva la logica del permission mode corrente (auto mode incluso). Fonte: [GitHub Releases v2.1.259](https://github.com/anthropics/claude-code/releases/tag/v2.1.259). Doc: [docs/16-headless-agent-sdk.md § 16.1](./docs/16-headless-agent-sdk.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **v2.1.259 riconosce i comandi `glab mr`** (2 set): le merge request GitLab (create/merge/close/reopen/note/update) appaiono ora come badge `MR !N` nel riepilogo tool, alla pari delle PR GitHub. Fonte: [GitHub Releases v2.1.259](https://github.com/anthropics/claude-code/releases/tag/v2.1.259). Doc: [docs/17-ide-surface.md § 17.9](./docs/17-ide-surface.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **v2.1.259 aggiunge `--json` a `claude plugin validate`** (2 set): report di validazione plugin in formato machine-readable, per integrarlo nella CI dei marketplace plugin. Fonte: [GitHub Releases v2.1.259](https://github.com/anthropics/claude-code/releases/tag/v2.1.259). Doc: [docs/11-plugins-marketplace.md § 11.3](./docs/11-plugins-marketplace.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **Fix rilevanti v2.1.259** (2 set): sessioni concorrenti che si sovrascrivevano a vicenda `~/.claude.json`, regole deny Bash `Read()` che non coprivano file passati come valore di un'opzione, auto mode che eseguiva modelli non supportati dal frontmatter di comandi/skill. Fonte: [GitHub Releases v2.1.259](https://github.com/anthropics/claude-code/releases/tag/v2.1.259). Doc: [docs/19-changelog.md](./docs/19-changelog.md).
- **Claude Commerce Agents**: Anthropic apre come open source un blueprint per agenti shopping/merchant (retail, travel, telecom, entertainment), con un plugin Claude Code dedicato che costruisce l'agente sul backend del team. Fonte: [Anthropic blog](https://claude.com/blog/claude-for-commerce-agents) · [@ClaudeDevs](https://x.com/ClaudeDevs/status/2095233745167282602) · [GitHub anthropics/commerce-agents](https://github.com/anthropics/commerce-agents). Doc: [docs/11-plugins-marketplace.md § 11.11](./docs/11-plugins-marketplace.md).
- **Enterprise Frontier Safeguards (EFS)**: nuova offerta enterprise che combina zero data retention con rilevamento automatico di misuso, dati conservati nel cloud del cliente invece che di Anthropic; rollout a fasi da autunno 2026, nel frattempo zero data retention su Fable 5/5.1. Fonte: [Anthropic news](https://www.anthropic.com/news/enterprise-frontier-safeguards). Doc: [docs/18-settings-auth.md § 18.6](./docs/18-settings-auth.md).

Il resto della release v2.1.259 (miglioramenti VS Code alla sidebar delle sessioni, altri fix minori) resta sotto la soglia editoriale.
