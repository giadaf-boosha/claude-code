...
>
> _Verificato: v2.1.216 (20 lug) e' un bundle di soli bug fix e piccole impostazioni interne (`sandbox.filesystem.disabled`), senza feature abbastanza rilevante per la sezione — riga aggiunta comunque in [docs/19-changelog.md](./docs/19-changelog.md)._
