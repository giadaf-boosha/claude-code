...
> Nessuna novita' significativa nelle ultime 24 ore. L'unica release nel periodo (v2.1.233, 14 ago) contiene supporto GitLab merge request nei worktree, cgroup di memoria opt-in per il Bash tool e fix vari — sotto la soglia editoriale. Prossimo aggiornamento domani 07:00.
