...
Nessuna nuova release CLI (resta v2.1.278, 19 set), nessun annuncio Anthropic blog dedicato a Claude Code (ultimo il 17 set, "Projects redesigned") e nessun post rilevante dei team Boris/Cat/Noah/Thariq/@claudeai/@ClaudeDevs nelle ultime 24 ore.
