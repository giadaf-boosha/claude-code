...
## What's new today (2026-07-18)

> _Aggiornamento automatico dalle 07:00 Europe/Rome. Vedi [archive](./docs/whats-new-archive.md) per i giorni precedenti._

- **CLI v2.1.214** (18 lug): fix di sicurezza permessi — bypass in PowerShell 5.1, comandi Bash oltre 10.000 caratteri e comandi `docker`/Podman con flag di redirect al daemon ora richiedono conferma esplicita. Aggiunge il tool `EndConversation` per terminare sessioni con utenti abusivi o tentativi di jailbreak. Fonte: [GitHub Releases v2.1.214](https://github.com/anthropics/claude-code/releases/tag/v2.1.214). Vedi [docs/04-modalita-permessi.md](./docs/04-modalita-permessi.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **CLI v2.1.212** (17 lug): `/fork` copia ora la conversazione in una nuova sessione background invece di lanciare un subagente in-sessione; il vecchio comportamento diventa `/subtask`. Aggiunge limiti anti-loop: WebSearch max 200 chiamate/sessione e subagent spawn max 200/sessione (configurabili via env var). Fonte: [GitHub Releases v2.1.212](https://github.com/anthropics/claude-code/releases/tag/v2.1.212). Vedi [docs/08-subagents.md](./docs/08-subagents.md), [docs/03-slash-commands.md](./docs/03-slash-commands.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **CLI v2.1.212**: `/resume` nell'agent view apre un picker di sessioni passate (incluse quelle eliminate dalla lista) e le riprende come sessione background. Fonte: [GitHub Releases v2.1.212](https://github.com/anthropics/claude-code/releases/tag/v2.1.212). Vedi [docs/03-slash-commands.md](./docs/03-slash-commands.md).
- **CLI v2.1.211** (15 lug): fix sicurezza — le anteprime dei permessi ora neutralizzano caratteri bidirezionali e zero-width che potevano falsificare visivamente il testo del prompt di approvazione. Fonte: [GitHub Releases v2.1.211](https://github.com/anthropics/claude-code/releases/tag/v2.1.211). Vedi [docs/04-modalita-permessi.md](./docs/04-modalita-permessi.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **CLI v2.1.210** (14 lug): fix isolamento worktree — i subagenti con `isolation: 'worktree'` non possono piu' eseguire comandi git che modificano il repo principale invece del proprio worktree. Fonte: [GitHub Releases v2.1.210](https://github.com/anthropics/claude-code/releases/tag/v2.1.210). Vedi [docs/08-subagents.md](./docs/08-subagents.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **CLI v2.1.208** (14 lug): introduce la screen reader mode (`--ax-screen-reader` / setting `axScreenReader`) e corregge diversi memory leak in sessioni lunghe (fino a 64MB per server MCP stdio). Fonte: [GitHub Releases v2.1.208](https://github.com/anthropics/claude-code/releases/tag/v2.1.208). Vedi [docs/18-settings-auth.md](./docs/18-settings-auth.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **CLI v2.1.208**: migliora le prestazioni fino a 7x nei round di tool call con molti tool MCP (print/SDK) e riduce fino a 79x la dimensione dei transcript in sessioni edit-intensive. Fonte: [GitHub Releases v2.1.208](https://github.com/anthropics/claude-code/releases/tag/v2.1.208). Vedi [docs/19-changelog.md](./docs/19-changelog.md).
- **CLI v2.1.209** (14 lug): fix rapido — dialog come `/model` non sono piu' bloccati nelle sessioni background di `claude agents`. Fonte: [GitHub Releases v2.1.209](https://github.com/anthropics/claude-code/releases/tag/v2.1.209). Vedi [docs/19-changelog.md](./docs/19-changelog.md).
- **Boris Cherny — "Steps of AI Adoption"** (16 lug): framework a 5 livelli (0-4) di maturita' nell'adozione AI nei team, da "gated" (zero agenti) ad "AI-native" (1.000+ agenti) — Anthropic si posiziona allo step 3, Cherny dichiara di aver raggiunto personalmente lo step 4. Fonte: [@bcherny](https://x.com/bcherny/status/2077929379661844559). Vedi n/a.
- **CLI v2.1.211**: fix di un regression sul prompt caching per Bedrock, Vertex, Mantle e Foundry che fatturava come token freschi il blocco di contesto finale ad ogni richiesta. Fonte: [GitHub Releases v2.1.211](https://github.com/anthropics/claude-code/releases/tag/v2.1.211). Vedi [docs/19-changelog.md](./docs/19-changelog.md).
