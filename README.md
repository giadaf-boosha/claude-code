...
> Nessuna novita' significativa nelle ultime 24 ore. Ultima release nota resta **v2.1.278** (19 set, gia' coperta il 20 set). Nessun nuovo annuncio sul blog Anthropic ne' post team rilevante dai profili monitorati; il digest ufficiale settimanale resta fermo alla Week 37 (7-11 set). Prossimo aggiornamento domani 07:00.
