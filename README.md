...
> Nessuna novita' significativa nelle ultime 24 ore. L'unica release nel periodo (v2.1.233, 14 ago) contiene solo settings/fix incrementali (supporto merge request GitLab su `--worktree`, memory cgroup opzionale per il tool Bash, rimozione dei tool todo su Opus 4.8/Sonnet 5+), sotto la soglia editoriale. Prossimo aggiornamento domani 07:00.
