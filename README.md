...
L'unica release nella finestra (**v2.1.263**, 6 set) contiene solo bug fix e miglioramenti di affidabilita', senza feature — resta sotto la soglia editoriale. Nessun annuncio Anthropic blog, post team X o articolo tecnico rilevante su Claude Code nelle ultime 24 ore; il digest ufficiale settimanale resta fermo alla Week 34 (17-21 ago, gia' coperta).
