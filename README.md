...
- **`/verify` e `/code-review` non piu' auto-invocati** (v2.1.215, 19 lug): Claude smette di eseguire in autonomia le skill `/verify` e `/code-review` durante il lavoro — vanno richiamate esplicitamente quando servono. Fonte: [GitHub Releases v2.1.215](https://github.com/anthropics/claude-code/releases/tag/v2.1.215). Doc: [docs/03-slash-commands.md](./docs/03-slash-commands.md), [docs/19-changelog.md](./docs/19-changelog.md).
