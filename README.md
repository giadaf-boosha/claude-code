...
- **CLI v2.1.217** (21 lug): autocomplete shortcode emoji nel prompt (`:heart:` → ❤️, disattivabile con `emojiCompletionEnabled`); tetto di concorrenza subagent di default 20 (override `CLAUDE_CODE_MAX_CONCURRENT_SUBAGENTS`); fix `--max-budget-usd` che non fermava piu' i subagent in background; avviso quando la scrittura del transcript fallisce (disco pieno o session saving disattivo). Fonte: [GitHub Releases v2.1.217](https://github.com/anthropics/claude-code/releases/tag/v2.1.217). Doc: [docs/08-subagents.md](./docs/08-subagents.md), [docs/19-changelog.md](./docs/19-changelog.md).
- **CLI v2.1.216** (20 lug): nuova opzione `sandbox.filesystem.disabled` per disattivare l'isolamento filesystem mantenendo il controllo dell'egress di rete; risolto un rallentamento quadratico nella normalizzazione dei messaggi nelle sessioni lunghe (stall multi-secondo su resume e sessioni lunghe); vari fix su worktree, sessioni background e auto mode dopo scadenza/rotazione del token OAuth. Fonte: [GitHub Releases v2.1.216](https://github.com/anthropics/claude-code/releases/tag/v2.1.216). Doc: [docs/18-settings-auth.md](./docs/18-settings-auth.md), [docs/19-changelog.md](./docs/19-changelog.md).
