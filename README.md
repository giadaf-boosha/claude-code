...
> Nessuna novita' significativa nelle ultime 24 ore. L'unica release (v2.1.233, 14 ago) contiene solo bug fix, hardening di sicurezza e settings di nicchia (GitLab MR nel flag `--worktree`, cgroup di memoria per Bash, cache TTL configurabile per WebFetch), sotto la soglia editoriale. Prossimo aggiornamento domani 07:00.
