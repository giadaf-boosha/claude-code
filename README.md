...
> Ultimo aggiornamento: **14 settembre 2026, 07:00 CEST**.
> Versione CLI di riferimento: **v2.1.270** · Modello default **Sonnet 5** · Premium **Fable 5.1 / Opus 5** (Max plan; Opus 4.8 rimane disponibile via `/model`).
...
## What's new today (2026-09-14)

> _Aggiornamento automatico dalle 07:00 Europe/Rome. Vedi [archive](./docs/whats-new-archive.md) per i giorni precedenti._

- **CLI v2.1.270** (12 set): corregge una regressione introdotta in v2.1.269 che faceva ricomparire il prompt di permesso sui comandi Bash `git` di sola lettura dopo che una sessione restava aperta a lungo — solo fix, nessuna feature nuova. Fonte: [GitHub Releases v2.1.270](https://github.com/anthropics/claude-code/releases/tag/v2.1.270) · [CHANGELOG.md](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md). Doc: [docs/04-modalita-permessi.md](./docs/04-modalita-permessi.md), [docs/19-changelog.md](./docs/19-changelog.md).

Il limite settimanale +25% permanente (sostituisce il bonus temporaneo +50%) diventa effettivo proprio oggi 14 settembre, gia' anticipato nell'entry del 12 settembre ora in [archive](./docs/whats-new-archive.md) — nessuna informazione nuova. Nessun annuncio Anthropic blog dedicato su Claude Code nelle ultime 24 ore (anthropic.com/news non raggiungibile dalla rete di questa sessione, verificato via ricerca incrociata); nessun post X nuovo datato 13-14 settembre dal team (@bcherny, @_catwu, @noahzweben, @trq212, @alistaiir, @claudeai, @ClaudeDevs, @ClaudeCodeLog). Digest ufficiale settimanale ancora fermo alla Week 34 (17-21 ago).
