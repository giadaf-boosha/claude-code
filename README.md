...
> Nessuna novita' significativa nelle ultime 24 ore. L'unica release nel periodo (v2.1.252, 31 ago) contiene solo bug fix (Bash "task output swap refused" su alcuni Mac, "always allow" non salvato senza `.claude/settings.local.json`, sessioni Remote Control bloccate su connessioni degradate), sotto la soglia editoriale. Nessun annuncio Anthropic o post team dedicato su Claude Code nelle ultime 24-72 ore (incluso il gap 30-31 agosto non coperto dalla routine precedente).
