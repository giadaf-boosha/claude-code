...
Le release v2.1.262-268 (5-10 set: fix e affidabilita', `maxEffortLevel`, cap 1GB sui risultati dei tool, telemetria/pricing gateway per org) restano sotto la soglia editoriale — nessun nuovo comando, tool o feature di sistema. L'unico annuncio Anthropic del periodo ([Reducing cost and improving performance with Claude Platform](https://claude.com/blog/reducing-cost-and-improving-performance-with-claude-platform), 8-9 set) riguarda il Claude Platform/API in generale, non Claude Code specificamente. Doc: [docs/19-changelog.md](./docs/19-changelog.md).
