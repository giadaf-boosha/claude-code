...
> **2026-08-28 (auto-update)**: da v2.1.248 il cross-session messaging sulla stessa macchina funziona anche su Bedrock, Vertex e Foundry, e nelle sessioni con telemetria disattivata — la limitazione descritta sopra non vale piu' per questi casi. Fonte: [GitHub Releases v2.1.248](https://github.com/anthropics/claude-code/releases/tag/v2.1.248). Vedi anche README "What's new today" del giorno.
