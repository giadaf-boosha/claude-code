...
> **2026-09-15 (auto-update)**: il fast mode arriva anche nelle sessioni Claude Code Remote (cloud e self-hosted runner), non piu' solo locali (v2.1.271, 14 set). Fonte: [changelog](https://code.claude.com/docs/en/changelog). Vedi anche README "What's new today" del giorno.
