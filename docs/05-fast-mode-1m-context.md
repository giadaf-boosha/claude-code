...
> **2026-09-16 (auto-update)**: da v2.1.271 (14 set) il fast mode arriva anche nelle sessioni Claude Code Remote (cloud e self-hosted runner), non piu' solo nel terminale locale. Fonte: [GitHub Releases v2.1.271](https://github.com/anthropics/claude-code/releases/tag/v2.1.271). Vedi anche README "What's new today" del giorno.
