...
> **2026-08-06 (auto-update)**: la feature **Ultraplan** e' stata rimossa in v2.1.222 (4 ago 2026) — non e' piu' disponibile il planning cloud multi-agent descritto in questa sezione. Ultrareview resta attivo. Fonte: [GitHub Releases v2.1.222](https://github.com/anthropics/claude-code/releases/tag/v2.1.222). Vedi anche README "What's new today" del giorno.
