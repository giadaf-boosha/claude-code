...
> **2026-08-14 (auto-update)**: e' oggi il giorno del passaggio effettivo — le nuove sessioni su Pro, Max e Team partono ora in `auto` invece che in `manual`. Fonte: [Anthropic blog](https://claude.com/blog/auto-mode-default-in-claude-code). Vedi anche README "What's new today" del giorno.
