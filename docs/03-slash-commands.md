...
> **2026-08-06 (auto-update)**: da v2.1.223, `/review` e' un alias di `/code-review` (diff corrente o PR con `/code-review <level> <pr#>`, `/code-review ultra` per deep cloud review) e riusa l'ultimo effort level digitato. Fonte: [GitHub Releases v2.1.223](https://github.com/anthropics/claude-code/releases/tag/v2.1.223). Vedi anche README "What's new today" del giorno.
