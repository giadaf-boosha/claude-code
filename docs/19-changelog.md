...
| 12 set 2026 | v2.1.270 | Fix: comandi git read-only nel tool Bash che chiedevano permesso a sessione avanzata (regressione introdotta in v2.1.269). |

<sub>Aggiornato 2026-09-13 via daily what's new. Fonte: [GitHub Releases v2.1.270](https://github.com/anthropics/claude-code/releases/tag/v2.1.270) · [code.claude.com/docs/en/changelog](https://code.claude.com/docs/en/changelog) · [code.claude.com/docs/en/whats-new](https://code.claude.com/docs/en/whats-new). Nessuna voce editoriale: v2.1.270 e' un singolo fix di regressione, il digest ufficiale settimanale resta fermo alla Week 34 (17-21 ago), nessun annuncio Anthropic blog dedicato su Claude Code e nessun post team con nuova feature/comando/tool nelle ultime 24 ore.</sub>
