...
| 23 set 2026 | v2.1.281 | Config gateway enterprise (`assume_role`/`guardrail` su upstream Bedrock, `telemetry.resource_attributes`), `"attribution": false` in `settings.json` per nascondere le righe di attribution su commit/PR, elicitation URL-mode per server MCP sul protocollo 2026-07-28. Release enorme di fix su prompt cache, resume sessione, PDF grandi e dialog. |
| 23 set 2026 | — | **Claude Marketplace**: nuovo hub unico Anthropic con oltre 2.000 connector/plugin, prodotti e agenti Claude-powered di partner (Cursor, Harvey, Lovable, Snowflake...) e il Claude Partner Network di consulenza — assorbe e amplia il marketplace plugin di Claude Code, vedi [11.2b](./11-plugins-marketplace.md#claude-marketplace-il-catalogo-unificato-da-23-set-2026). Fonte: [Anthropic blog](https://claude.com/blog/claude-marketplace). |

<sub>Aggiornato 2026-09-24 via daily what's new. Fonte: [Anthropic blog](https://claude.com/blog/claude-marketplace) · [GitHub Releases v2.1.281](https://github.com/anthropics/claude-code/releases/tag/v2.1.281). Unica voce editoriale: il lancio del **Claude Marketplace**, hub unificato che include e amplia il marketplace plugin di Claude Code. Il resto della release v2.1.281 (config gateway enterprise per Bedrock/Claude Desktop, `attribution: false`, elicitation MCP URL-mode, un lungo elenco di fix di affidabilita') resta sotto la soglia editoriale. Nessun altro post team rilevante nelle ultime 24-48 ore.</sub>
