...
<sub>Aggiornato 2026-08-28 via daily what's new. Fonte: [GitHub Releases v2.1.247](https://github.com/anthropics/claude-code/releases/tag/v2.1.247) · [v2.1.248](https://github.com/anthropics/claude-code/releases/tag/v2.1.248) · [v2.1.250](https://github.com/anthropics/claude-code/releases/tag/v2.1.250) · [CHANGELOG.md](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) · [claude.com/blog](https://claude.com/blog) (memoria ovunque, Claude in Chrome GA, browser in Cowork). Nessuna voce editoriale sul CLI: `--restricted` e le altre novita' restano feature/flag opt-in sotto soglia; i tre post blog sono coperti in README e nei capitoli target (06b, 17).</sub>
