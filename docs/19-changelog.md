...
Cronologia completa di Claude Code dalla research preview (24 febbraio 2025, v0.2.0) all'ultima versione (6 settembre 2026, v2.1.263). 7 fasi storiche + tabella versione per versione + post-mortem aprile 2026.
...
| 6 set 2026 | v2.1.263 | Bug fix e miglioramenti di affidabilita' (nessun dettaglio pubblico aggiuntivo nelle release notes). |

<sub>Aggiornato 2026-09-07 via daily what's new. Fonte: [@bcherny](https://x.com/bcherny/status/2095590515765060076) · [@ClaudeDevs](https://x.com/ClaudeDevs/status/2095572891941351550) · [GitHub Issue #91870](https://github.com/anthropics/claude-code/issues/91870) · [@trq212](https://x.com/trq212/status/2095367584489038044). Nessuna release nelle ultime 24h vere e proprie (6-7 set): v2.1.263 (6 set) e' gia' in tabella e resta sotto soglia. Le due voci editoriali di oggi (Function Hooks preview, effort level senza cache miss su Fable 5.1/Opus 5) sono un recupero di novita' del 3 set rimaste scoperte tra un run e l'altro. Nessun annuncio Anthropic blog dedicato nelle ultime 24 ore.</sub>
