...
| 14 ago 2026 (annuncio 7 ago) | — | **Auto mode default Pro/Max/Team**: dal 14 agosto le nuove sessioni su piani Pro, Max e Team partono in auto mode invece che in modalita' manuale — classifier separato blocca azioni irreversibili/distruttive/fuori ambiente. Test su 1.053 tester paganti: 89% comandi pericolosi bloccati dal classifier contro 13,6% (in calo al ~5% dopo 50 prompt) dell'approvazione umana manuale. Enterprise e API restano opt-in. Vedi [4.3 Auto mode](./04-modalita-permessi.md#43-auto-mode-research-preview-da-v2183). [Anthropic blog](https://claude.com/blog/auto-mode-default-in-claude-code) · [@ClaudeDevs](https://x.com/ClaudeDevs/status/2085794862608318627). |

<sub>Aggiornato 2026-08-10 via daily what's new. Fonte: [Anthropic blog](https://claude.com/blog/auto-mode-default-in-claude-code) · [@ClaudeDevs](https://x.com/ClaudeDevs/status/2085794862608318627).</sub>
