...
| 12 set 2026 | v2.1.270 | Fix di regressione: i comandi Bash git read-only (es. `git status`, `git log`) avevano ripreso a chiedere permesso invece di auto-approvarsi dopo che una sessione girava da un po', bug introdotto in v2.1.269. |

<sub>Aggiornato 2026-09-13 via daily what's new. Fonte: [GitHub Releases v2.1.270](https://github.com/anthropics/claude-code/releases/tag/v2.1.270). Unica voce editoriale del giorno: fix di regressione sui permessi Bash per comandi git read-only (v2.1.269 → v2.1.270). Nessun annuncio Anthropic blog o post team dedicato su Claude Code nelle ultime 24 ore; digest ufficiale settimanale fermo alla Week 34 (17-21 ago).</sub>
