...
| 24 lug 2026 | — | **Claude Opus 5**: nuovo modello Opus di punta, si avvicina a Fable 5 a meta' prezzo, 1M context, nuovo SOTA su coding agentico (Frontier-Bench v0.1, 43.3% — oltre il doppio di Opus 4.8), stesso pricing di Opus 4.8 ($5/$25 Mtok). Il modello Opus piu' allineato finora. [Anthropic news](https://www.anthropic.com/news/claude-opus-5) · [@ClaudeDevs](https://x.com/ClaudeDevs/status/2080703243722854516). |
| 24 lug 2026 | **v2.1.219** | Integra **Opus 5** come modello Opus default. Nuovi: `sandbox.network.strictAllowlist` (nega host non in allowlist per comandi sandboxati senza prompt), hook `DirectoryAdded` (dopo `/add-dir` o `register_repo_root`), forwarding subagent annidati in stream-json, setting `workflowSizeGuideline`. Subagent possono ora spawnare subagent annidati fino a profondita' 3 (era 1; `CLAUDE_CODE_MAX_SUBAGENT_SPAWN_DEPTH=1` per disattivare). Fix: dynamic workflow size default a medium (<15 agent), Opus 4.7 rimosso da fast mode. |
| 25 lug 2026 | v2.1.220 | Bug fix e miglioramenti di affidabilita' — dettagli non specificati nel changelog ufficiale. |
...
<sub>Aggiornato 2026-07-25 via daily what's new. Fonte: [Anthropic news](https://www.anthropic.com/news/claude-opus-5) · [GitHub Releases v2.1.219](https://github.com/anthropics/claude-code/releases/tag/v2.1.219) · [v2.1.220](https://github.com/anthropics/claude-code/releases/tag/v2.1.220) · [@trq212](https://x.com/trq212/status/2080710971228918066) · [@ClaudeDevs](https://x.com/ClaudeDevs/status/2080703243722854516).</sub>
