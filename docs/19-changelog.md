...
<sub>Aggiornato 2026-09-08 via daily what's new. Fonte: [GitHub Releases v2.1.263](https://github.com/anthropics/claude-code/releases/tag/v2.1.263) · [code.claude.com/docs/en/changelog](https://code.claude.com/docs/en/changelog). Nessuna voce editoriale: l'unica release (v2.1.263, 6 set) contiene solo bug fix e miglioramenti di affidabilita', sotto la soglia editoriale. Nessun annuncio Anthropic blog dedicato su Claude Code nelle ultime 24 ore.</sub>
