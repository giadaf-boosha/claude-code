...
<sub>Aggiornato 2026-09-07 via daily what's new. Fonte: [GitHub Releases v2.1.263](https://github.com/anthropics/claude-code/releases/tag/v2.1.263) · [code.claude.com/docs/en/changelog](https://code.claude.com/docs/en/changelog). Nessuna voce editoriale: unica release del periodo (v2.1.263, 6 set) e' solo bug fix, sotto soglia. Nessun annuncio Anthropic blog o post team dedicato su Claude Code nelle ultime 24 ore.</sub>
