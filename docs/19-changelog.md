...
| 30 giu 2026 | **v2.1.197** | **Claude Sonnet 5 come modello default**: Sonnet 5 e' il nuovo default in Claude Code per tutti i piani — context window nativo 1M token, pricing promozionale $2/$10 per MTok fino al 31 agosto 2026. Il Sonnet piu' agentico mai creato: supera Sonnet 4.6 su tutti i benchmark di coding e computer use, si avvicina a Opus 4.8 a pricing Sonnet. [Anthropic blog](https://www.anthropic.com/news/claude-sonnet-5) |

> **2026-07-01 (auto-update)**: v2.1.197 introduce Claude Sonnet 5 come modello default in Claude Code (context window nativo 1M token, $2/$10 per MTok promo fino al 31 ago 2026); contestualmente Anthropic lancia Claude Desktop su Linux (Ubuntu/Debian, beta) e Boris Cherny annuncia subagent background-by-default nella prossima release. Fonte: [GitHub Releases v2.1.197](https://github.com/anthropics/claude-code/releases/tag/v2.1.197). Vedi anche README "What's new today" del giorno.
