...
| 18 ago 2026 | v2.1.235 | Nuovo setting opzionale `spellcheck` (sottolinea parole errate nel prompt input via `aspell`/`hunspell`/`ispell`). Migliorie memoria/CPU per sessioni cloud in background (`/ultrareview`, `/autofix-pr`). Fix: invalidazione cache prompt su riconnessione language server, allineamento liste markdown annidate a profondita' 3+, `Shift+Tab` nel campo commento del permission prompt, dialog notebook che omettevano il contenuto celle illeggibili, entita' HTML al posto dei caratteri nei menu slash command. |

<sub>Aggiornato 2026-08-19 via daily what's new. Fonte: [GitHub Releases v2.1.235](https://github.com/anthropics/claude-code/releases/tag/v2.1.235). Nessuna voce editoriale: solo fix e feature minori, sotto soglia.</sub>
