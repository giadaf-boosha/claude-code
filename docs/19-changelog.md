...
| 6 set 2026 | v2.1.263 | Bug fix e miglioramenti di affidabilita', nessuna feature. |

<sub>Aggiornato 2026-09-06 via daily what's new. Fonte: [GitHub Releases v2.1.263](https://github.com/anthropics/claude-code/releases/tag/v2.1.263) · [code.claude.com/docs/en/changelog](https://code.claude.com/docs/en/changelog) · [code.claude.com/docs/en/whats-new](https://code.claude.com/docs/en/whats-new). Nessuna voce editoriale: l'unica release della finestra (v2.1.263) e' solo bug fix, sotto soglia. Nessun annuncio Anthropic blog, post team X o articolo tecnico dedicato su Claude Code nelle ultime 24 ore; digest settimanale ufficiale ancora fermo alla Week 34.</sub>
