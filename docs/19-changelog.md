...
| 24 ago 2026 | v2.1.243 | Bug fix e miglioramenti di affidabilita' (v2.1.242 non risulta pubblicata, salto di build interno). |

<sub>Aggiornato 2026-08-25 via daily what's new. Fonte: [GitHub Releases v2.1.243](https://github.com/anthropics/claude-code/releases/tag/v2.1.243) · [CHANGELOG.md](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md). Nessuna voce editoriale: solo fix, sotto soglia.</sub>
