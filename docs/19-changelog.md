...
Cronologia completa di Claude Code dalla research preview (24 febbraio 2025, v0.2.0) all'ultima versione (12 settembre 2026, v2.1.270). 7 fasi storiche + tabella versione per versione + post-mortem aprile 2026.
...
| 12 set 2026 | v2.1.270 | Fix: regressione di v2.1.269 che faceva ricomparire il prompt di permesso sui comandi Bash `git` di sola lettura dopo che una sessione restava aperta a lungo — vedi [4.1](./04-modalita-permessi.md#41-permission-modes). |

<sub>Aggiornato 2026-09-14 via daily what's new. Fonte: [GitHub Releases v2.1.270](https://github.com/anthropics/claude-code/releases/tag/v2.1.270) · [CHANGELOG.md](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md). Unica voce editoriale: fix della regressione read-only git introdotta in v2.1.269 (nuova versione CLI). Nessun annuncio Anthropic blog dedicato nelle ultime 24 ore; nessun post X nuovo dal team datato 13-14 set; digest ufficiale settimanale fermo alla Week 34 (17-21 ago).</sub>
