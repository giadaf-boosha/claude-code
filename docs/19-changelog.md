...
Cronologia completa di Claude Code dalla research preview (24 febbraio 2025, v0.2.0) all'ultima versione (23 agosto 2026, v2.1.241). 7 fasi storiche + tabella versione per versione + post-mortem aprile 2026.
...
| 17-21 ago 2026 (w34) | **v2.1.233+** | **`/design`** (research preview): porta il workflow ad artboard di Claude Design dentro CLI e Desktop, costruito su Artifacts — Claude pubblica un canvas di artboard editabili da un brief, l'utente ne sceglie una e Claude la implementa. Non era stata segnalata dalle release notes puntuali (v2.1.233-239), emersa solo dal digest settimanale — vedi [09.1](./09-skills.md#91-bundled-skills-sempre-disponibili) e [03.1](./03-slash-commands.md#31-tabella-completa). |
...
<sub>Aggiornato 2026-08-25 via daily what's new. Nessuna release nuova nelle ultime 24 ore (ultima resta v2.1.241, 23 ago). Fonte: [Week 34 whats-new digest](https://code.claude.com/docs/en/whats-new/2026-w34) — recupero editoriale del comando `/design`, gia' disponibile da v2.1.233 ma mai segnalato nelle release notes puntuali.</sub>
