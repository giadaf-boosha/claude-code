...
| 28 lug 2026 | — | **MCP 2026-07-28**: nuova spec Model Context Protocol, il maggior aggiornamento dal lancio — core stateless (request/response, deploy serverless/edge), OAuth/OIDC piu' robusti, estensioni **MCP Apps** (UI server-rendered in iframe sandboxato), **Tasks** (operazioni long-running/async) e **Server Cards** (capability discovery). Claude adotta il nuovo standard nei prossimi rollout. [Anthropic blog](https://claude.com/blog/bringing-mcp-2026-07-28-to-claude) · [MCP spec blog](https://blog.modelcontextprotocol.io/posts/2026-07-28/) · [@ClaudeDevs](https://x.com/ClaudeDevs/status/2082164248697069935). Vedi [10.1 Configurazione base](./10-mcp.md). |
...
<sub>Aggiornato 2026-07-29 via daily what's new. Fonte: [Anthropic blog](https://claude.com/blog/bringing-mcp-2026-07-28-to-claude) · [MCP spec blog](https://blog.modelcontextprotocol.io/posts/2026-07-28/) · [@ClaudeDevs](https://x.com/ClaudeDevs/status/2082164248697069935).</sub>
