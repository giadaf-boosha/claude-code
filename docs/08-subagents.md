...
> **2026-06-25 (auto-update)**: da v2.1.191 fermare un agent dal task panel e' ora permanente — prima il background agent si rigenerava autonomamente dopo essere stato fermato. Il comportamento corretto e' che stop = stop definitivo per quella sessione. Fonte: [GitHub Releases v2.1.191](https://github.com/anthropics/claude-code/releases/tag/v2.1.191). Vedi anche README "What's new today" del giorno.
