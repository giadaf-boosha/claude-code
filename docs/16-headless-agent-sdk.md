...
> **2026-09-03 (auto-update)**: nuovo flag `--permission-prompts none` (v2.1.259) per host headless senza operatore — nega automaticamente qualsiasi azione che richiederebbe un prompt, lasciando comunque attiva la logica del permission mode corrente (auto mode incluso). Fonte: [GitHub Releases v2.1.259](https://github.com/anthropics/claude-code/releases/tag/v2.1.259). Vedi anche README "What's new today" del giorno.
