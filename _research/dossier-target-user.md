# Dossier — Guide per target user di Claude Code

> Bozza di lavoro per la futura sezione `docs/21-guide-target-user.md`. Ogni profilo e' pensato come **percorso autonomo**: setup, comandi, skill, workflow tipico, anti-pattern. I link interni puntano a `docs/` della repo `claude-code`.
...
- **Sandbox**: ON (default su macOS). Vedi [`docs/04-modalita-permessi.md`](../docs/04-modalita-permessi.md).
...
### Risorse
- [`docs/04-modalita-permessi.md`](../docs/04-modalita-permessi.md) — capire plan mode prima di tutto
- [`docs/17-ide-surface.md`](../docs/17-ide-surface.md) — Desktop app e Web
- [`docs/06-claude-md-memory.md`](../docs/06-claude-md-memory.md) — come funziona CLAUDE.md
- [`docs/20-tips-best-practices.md`](../docs/20-tips-best-practices.md) — Boris: "setup vanilla > customization"
...
### Caso d'uso flagship
**Da issue a PR mergiata in 2 ore.** Issue su GitHub -> `/ultraplan` la legge e produce piano -> CLI esegue il piano -> `/ultrareview` blocca o approva -> autore mergia. Vedi [`docs/15-ultraplan-ultrareview.md`](../docs/15-ultraplan-ultrareview.md).

### Cosa NON fare
1. Non lasciare `/loop` senza idempotenza (vedi [`docs/14-loop-monitor.md`](../docs/14-loop-monitor.md))
2. Non usare fast mode per task brevi: paghi senza guadagnare
3. Non skippare plan mode su refactor cross-file

### Risorse
- [`docs/14-loop-monitor.md`](../docs/14-loop-monitor.md)
- [`docs/13-routines-cloud.md`](../docs/13-routines-cloud.md)
- [`docs/15-ultraplan-ultrareview.md`](../docs/15-ultraplan-ultrareview.md)
- [`docs/05-fast-mode-1m-context.md`](../docs/05-fast-mode-1m-context.md)
...
### Caso d'uso flagship
**Aggiungere un endpoint con full test coverage.** Plan mode -> implementazione service+repository+controller -> integration test con Testcontainers -> security-review -> PR. La GitHub Action gira ultrareview e commenta. Vedi [`docs/16-headless-agent-sdk.md`](../docs/16-headless-agent-sdk.md).

### Cosa NON fare
1. Non auto-mergiare PR generate da AI senza human-in-the-loop
2. Non disattivare sandbox per "velocita'"
3. Non lasciare CLAUDE.md monolitico: usa `@import` per layer (vedi [`docs/06-claude-md-memory.md`](../docs/06-claude-md-memory.md))

### Risorse
- [`docs/18-settings-auth.md`](../docs/18-settings-auth.md) — managed settings Team
- [`docs/07-hooks.md`](../docs/07-hooks.md) — formatter / linter automatici
- [`docs/15-ultraplan-ultrareview.md`](../docs/15-ultraplan-ultrareview.md)
- [`docs/16-headless-agent-sdk.md`](../docs/16-headless-agent-sdk.md) — GitHub Actions
...
### Risorse
- [`docs/17-ide-surface.md`](../docs/17-ide-surface.md) — Computer use, VS Code, Remote Control
- [`docs/14-loop-monitor.md`](../docs/14-loop-monitor.md) — Monitor tool con dev server
...
### Caso d'uso flagship
**Postmortem semi-automatico.** Dopo un incident, sessione headless con accesso a logs Datadog (MCP) -> timeline ricostruita -> action items -> documento markdown firmato dal team. Vedi [`docs/13-routines-cloud.md`](../docs/13-routines-cloud.md).
...
### Risorse
- [`docs/13-routines-cloud.md`](../docs/13-routines-cloud.md)
- [`docs/16-headless-agent-sdk.md`](../docs/16-headless-agent-sdk.md)
- [`docs/10-mcp.md`](../docs/10-mcp.md) — MCP per Datadog/AWS/etc
- [`docs/18-settings-auth.md`](../docs/18-settings-auth.md) — Enterprise auth
...
### Risorse
- [`docs/06-claude-md-memory.md`](../docs/06-claude-md-memory.md)
- [`docs/12-agent-teams.md`](../docs/12-agent-teams.md)
- [`docs/18-settings-auth.md`](../docs/18-settings-auth.md)
- [`docs/15-ultraplan-ultrareview.md`](../docs/15-ultraplan-ultrareview.md)
...
### Risorse
- [`docs/05-fast-mode-1m-context.md`](../docs/05-fast-mode-1m-context.md) — 1M context per RAG su contesti lunghi
- [`docs/10-mcp.md`](../docs/10-mcp.md)
- [`docs/16-headless-agent-sdk.md`](../docs/16-headless-agent-sdk.md) — SDK Python/TS
- [`docs/09-skills.md`](../docs/09-skills.md) — skill claude-api
...
> Output style **"Explanatory"** o **"Learning"** consigliato (vedi [`docs/20-tips-best-practices.md § 4`](../docs/20-tips-best-practices.md)): Claude spiega *perche'* il codice legacy fa cio' che fa.
...
### Risorse
- [`docs/06-claude-md-memory.md`](../docs/06-claude-md-memory.md) — `/init` ricco con `CLAUDE_CODE_NEW_INIT=1`
- [`docs/05-fast-mode-1m-context.md`](../docs/05-fast-mode-1m-context.md) — 1M context per source legacy lunghi
- [`docs/04-modalita-permessi.md`](../docs/04-modalita-permessi.md) — plan mode rigoroso
- [`docs/15-ultraplan-ultrareview.md`](../docs/15-ultraplan-ultrareview.md) — design modernizzazione
...
- I link `docs/...` sono relativi a `_research/` -> usano `../docs/...`. Quando il file viene spostato in `docs/21-guide-target-user.md`, sostituire con `./NN-*.md`.
- Alcuni dettagli (es. server MCP specifici per IBM i, link skill marketplace community per legacy) sono lasciati come "vedi `docs/10-mcp.md`" / "vedi `docs/11-plugins-marketplace.md`" placeholder finche' non verificati.
- Tabella sintesi finale e' duplicata rispetto al body: in revisione decidere se tenere entrambi o solo body.
